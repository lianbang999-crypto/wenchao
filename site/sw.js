...
const VER = 'wc-v68';   // v43 曾被已回滚的 07-12 重设计短暂占用，跳过避免缓存名撞车
...
const SHELL = ['./', 'index.html', 'css/app.css?v=20260830-app20', 'js/app.js?v=20260830-app20', 'js/ai-core.js', 'js/share.js?v=20260830-app20', 'js/pwa.js?v=20260830-app20', 'js/offline.js?v=20260830-app20', 'config.js?v=20260830-app20', 'icon.svg', 'manifest.webmanifest', 'img/icons/icon-192.png', 'img/icons/maskable-192.png', 'apple-touch-icon.png', 'data/books.json'];
